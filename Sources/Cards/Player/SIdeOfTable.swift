...
public enum SideOfTable:Int
{
    ...
    public func positionOfCard(_ positionInSpread: CGFloat, spriteHeight: CGFloat, width: CGFloat, height: CGFloat, fullHand: CGFloat = CardPile.defaultSpread) -> CGPoint
    {
        ...
        let left : CGFloat =  width*0.04
        let right : CGFloat =  width*0.96
        switch self
        {
            // Player One
        case .bottom:
    ...
    public func positionOfPassingPile( _ spriteHeight: CGFloat, width: CGFloat, height: CGFloat) -> CGPoint
    {
        var startheight = CGFloat(0.0)
        var startWidth = width * 0.35
