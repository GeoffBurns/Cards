...
public class CardSprite : SKSpriteNode
{
    ...
    public var player : CardHolderBase? = nil
    public var card : PlayingCard
    public var isUp = false
    public var positionInSpread = CGFloat(0.0)
    public var state = CardState.atRest
    public var originalTouch : CGPoint = CGPoint.zero
    public var label : SKLabelNode? = nil
    public var localLabel : SKSpriteNode? = nil
    public var letterBackground : SKSpriteNode? = nil
    public var originalScale = CGFloat(1.0)
    public var originalCardPosition   = CGPoint.zero
    public var originalCardRotation  = CGFloat(0.0)
    public var originalCardZPosition  = CGFloat(0.0)
...
extension SKNode
{
 public func cardSpriteNamed(_ cardname :String) -> CardSprite?
    {
    return (self.childNode(withName: cardname) as? CardSprite?) ?? nil
    }
public func cardSprite(_ card :PlayingCard) -> CardSprite?
    {
...
public func whiteCardSprite(_ card :PlayingCard) -> CardSprite?
    {
...
public func cardSprite(_ card :PlayingCard,isUp: Bool) -> CardSprite?
{
    if let sprite = self.cardSpriteNamed(card.imageName)
    {
        return sprite
