...
public enum CardSize
{
    ...
    public static var hugeScale = DeviceSettings.isPhone ?
        (DeviceSettings.isBigPhone ? CGFloat(0.9) : CGFloat(0.6))
        : CGFloat(1.2)
    public static var bigScale = DeviceSettings.isPhone ?
        (DeviceSettings.isBigPhone ? CGFloat(0.6) : CGFloat(0.45))
        : CGFloat(0.9)
    public static var mediumScale = DeviceSettings.isPhone ? CGFloat(0.3) : CGFloat(0.6)
    public static var smallScale = DeviceSettings.isPhone ? CGFloat(0.22) : CGFloat(0.45)
